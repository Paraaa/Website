  ...
  return (
    <div className="min-h-screen bg-[#F9F7F2] text-[#2D3A3A]">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-32 pb-24">
        ...
        <p>Andrej Schwanke Südring 24 79189 Bad Krozingen</p>
        <p>
          E-Mail-Adresse:{" "}
          <a href="mailto:andrejschwanke19@gmail.com">
            andrejschwanke19@gmail.com
          </a>
        </p>
        ...
        <p>
          ...
          eingebunden sind. In solchen Fällen beachten wir die gesetzlichen
        ...
        <p>
          ...
          ausdrücklich zu einem bestimmten Datum und beträgt sie mindestens ein
          Jahr, so startet sie automatisch am Ende des Kalenderjahres, in dem
